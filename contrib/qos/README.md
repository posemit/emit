...
This means one can have an always-on northernd instance running, and another local northernd/emit-qt instance which connects to this node and receives blocks from it.
