...
```bash
    ...
    From https://github.com/emit/emit
...
For example:
```bash
URL=https://github.com/konez2k/emit.git
...
[emit/gitian.sigs](https://github.com/emit/gitian.sigs/) repository, or if that's not possible to create a pull
request.
