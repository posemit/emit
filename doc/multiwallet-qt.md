...
In order to support loading of multiple wallets in emit-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is emit.cpp.
...
Changes to emit.cpp
----------------------
emit.cpp is the entry point into emit-qt, and as such, will require some minor modifications to provide hooks for
