...
#   c) node1 mines 32 blocks, so now node 0 has 500000NORT, node 1 has 4250NORT, node2 has none.
#   d) node0 sends 601 EMIT to node2, in two transactions (301 EMIT, then 300 EMIT).
