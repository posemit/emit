Contributing to EMIT Core
==================================

The EMIT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EMIT Core project, and is not to be
confused with overall EMIT Network Protocol consensus changes.

Whether a pull request is merged into EMIT Core rests with the project merge
...
The project leader is the release manager for each EMIT Core release.
